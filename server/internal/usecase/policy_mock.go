...
// CanManageTeam provides a mock function with given fields: userID, teamID
func (_m *MockPolicy) CanManageTeam(userID string, teamID string) bool {
...
// MockPolicy_CanManageTeam_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CanManageTeam'
type MockPolicy_CanManageTeam_Call struct {
	*mock.Call
}
...
//   - userID string
//   - teamID string
func (_e *MockPolicy_Expecter) CanManageTeam(userID interface{}, teamID interface{}) *MockPolicy_CanManageTeam_Call {
	return &MockPolicy_CanManageTeam_Call{Call: _e.mock.On("CanManageTeam", userID, teamID)}
}

func (_c *MockPolicy_CanManageTeam_Call) Run(run func(userID string, teamID string)) *MockPolicy_CanManageTeam_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string))
	})
	return _c
...
func (_c *MockPolicy_CanManageTeam_Call) Return(_a0 bool) *MockPolicy_CanManageTeam_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockPolicy_CanManageTeam_Call) RunAndReturn(run func(string, string) bool) *MockPolicy_CanManageTeam_Call {
	_c.Call.Return(run)
	return _c
}
